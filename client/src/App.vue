        ...
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <router-link to="/" class="flex items-center space-x-2">
              ...
              <span class="text-xl font-bold text-gray-900">Elegant Furniture</span>
            </router-link>
          </div>
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <p class="text-gray-400">Quality furniture for every room in your home.</p>
          </div>
          <div>
            <h4 class="text-md font-semibold mb-4">Products</h4>
        ...
        <div class="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
          <p>&copy; 2024 Elegant Furniture. All rights reserved.</p>
        </div>
      </div>
    </footer>
  </div>
